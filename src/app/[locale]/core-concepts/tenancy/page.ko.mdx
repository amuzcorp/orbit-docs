...
테넌시는 다중 테넌트 애플리케이션에서 중요한 개념입니다. 동일한 애플리케이션 인스턴스를 공유하면서도 다른 테넌트 간의 데이터와 리소스를 분리할 수 있게 합니다.

## 주요 개념

- **테넌트 격리**: 각 테넌트의 데이터와 리소스 분리
- **공유 리소스**: 공통 리소스를 효율적으로 공유
- **테넌트 컨텍스트**: 테넌트별 컨텍스트 유지
- **보안**: 적절한 데이터 격리 보장
